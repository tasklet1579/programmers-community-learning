...
class Solution {
    ...
    public String[] solution(String[][] booked, String[][] unbooked) {
     ...
     //public int timeB(String[][] booked,  int idx) {
     //    return Integer.parseInt(booked[idx][ARRIVAL].substring(0,  2)) * 60
     //            + Integer.parseInt(booked[idx][ARRIVAL].substring(3,  5));
     //}
//
     //public int timeU(String[][] unbooked,  int idx) {
     //    return Integer.parseInt(unbooked[idx][ARRIVAL].substring(0,  2)) * 60
     //            + Integer.parseInt(unbooked[idx][ARRIVAL].substring(3,  5));
     //}

    public int time(String[][] time, int idx) {
        return Integer.parseInt(time[idx][ARRIVAL].substring(0,  2)) * 60
                + Integer.parseInt(time[idx][ARRIVAL].substring(3,  5));
    }
}
